...
public class LocationController {
  ...
  public ResponseEntity<?> createLocation(
    ...
    try {
      ...
      if (
        locationRepository.existsByLocationNameIgnoreCase(
      ...
      if (locationOptional.isPresent()) {
        ...
        if (locationDetails.getLocationName() != null) {
          ...
          if (
            !locationDetails
              .getLocationName()
              .equalsIgnoreCase(location.getLocationName()) &&
            locationRepository.existsByLocationNameIgnoreCase(
  ...
  public ResponseEntity<?> deleteLocation(@PathVariable Integer id) {
    try {
      Optional<Location> locationOptional =
        locationRepository.findByIdWithServices(id);
      ...
      if (locationOptional.isPresent()) {
        ...
        if (!location.getServices().isEmpty()) {
          ...
          error.put(
            "error",
            "Cannot delete location that has services. Please delete services first."
          );
          return ResponseEntity.badRequest().body(error);
        }
